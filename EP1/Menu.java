            ...
            if (sc.hasNextInt()) { // Verifica se a próxima entrada é um Inteiro
                ...
                switch (opcaoPrincipal) { // Processa a opção escolhida
                    case 1:
                        ...
                        System.out.println("Função 1- Cadastrar novo aluno");
                        System.out.println("Função 2 - Editar aluno existente");
                        System.out.println("Função 3 - Listar alunos cadastrados no sistema");
                        System.out.println("Função 4 - Trancar disciplina/semestre");
